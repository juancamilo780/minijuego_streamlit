...
st.title("Mini-juego de Amor 💖")
st.write("¡Hola, mi amor! Bienvenida al mini-juego donde descubrirás cuánto te amo.")
...
if st.button("¿Cuántas veces piensas en mí?"):
    st.write("Pienso en ti cada segundo de cada día, sin excepciones. 💭❤️")
